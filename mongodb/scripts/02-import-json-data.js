// MongoDB Data Import Script for Audit POC
// This script imports JSON data from the data folder into MongoDB collections

print('📥 Starting JSON data import for Audit POC...');
...
function importDataForEnvironment(environment) {
  ...
  try {
    const journalEntries = JSON.parse(cat('/data/transactional/journal_entries/sample_journal_entries.json'));
  ...
  // Import payments
  try {
    const payments = JSON.parse(cat('/data/transactional/payments/sample_payments.json'));
  ...
  // Import trades
  try {
    const trades = JSON.parse(cat('/data/transactional/trades/sample_trades.json'));
  ...
  // Import customers
  try {
    const customers = JSON.parse(cat('/data/master_data/customer/customer_master.json'));
  ...
  // Import vendors
  try {
    const vendors = JSON.parse(cat('/data/master_data/vendor/vendor_master.json'));
  ...
  // Import accounts
  try {
    const accounts = JSON.parse(cat('/data/master_data/account_master/account_master.json'));
  ...
  // Import invoices
  try {
    const invoices = JSON.parse(cat('/data/supporting_docs/invoices/sample_invoices.json'));
  ...
  // Import contracts
  try {
    const contracts = JSON.parse(cat('/data/supporting_docs/contracts/sample_contracts.json'));
  ...
  // Import tax forms
  try {
    const taxForms = JSON.parse(cat('/data/supporting_docs/tax_forms/sample_tax_forms.json'));
  ...
  try {
    const loginRecords = JSON.parse(cat('/data/system_access_logs/login_records/sample_login_records.json'));
  ...
  try {
    const changeHistory = JSON.parse(cat('/data/system_access_logs/change_history/sample_change_history.json'));
  ...
  try {
    const approvalChains = JSON.parse(cat('/data/audit_trail/approval_chains/sample_approval_chains.json'));
  ...
  try {
    const changeTracking = JSON.parse(cat('/data/audit_trail/change_tracking/sample_change_tracking.json'));
  ...
  // Import KYC files
  try {
    const kycFiles = JSON.parse(cat('/data/compliance/kyc_files/sample_kyc_files.json'));
  ...
  try {
    const regulatoryFilings = JSON.parse(cat('/data/compliance/regulatory_filings/sample_regulatory_filings.json'));
  ...
  try {
    const exceptionLogs = JSON.parse(cat('/data/operational/exception_logs/sample_exception_logs.json'));
  ...
  try {
    const processTraces = JSON.parse(cat('/data/operational/process_mining_traces/sample_process_mining_traces.json'));
  ...
  try {
    const balanceSheet = JSON.parse(cat('/data/financial_reports/balance_sheet/sample_balance_sheet.json'));
  ...
  try {
    const plStatements = JSON.parse(cat('/data/financial_reports/pl_statement/sample_pl_statement.json'));
  ...
  // Import cash flow
  try {
    const cashFlow = JSON.parse(cat('/data/financial_reports/cash_flow/sample_cash_flow.json'));
  ...
  try {
    const auditReports = JSON.parse(cat('/data/external_data/audit_reports/sample_audit_reports.json'));
  ...
  try {
    const bankConfirmations = JSON.parse(cat('/data/external_data/bank_confirms/sample_bank_confirms.json'));
  ...
  // Import emails
  try {
    const emails = JSON.parse(cat('/data/communications/emails/sample_emails.json'));
  ...
  try {
    const meetingNotes = JSON.parse(cat('/data/communications/meeting_notes/sample_meeting_notes.json'));
  ...
  // Import metadata
  try {
    const metadata = JSON.parse(cat('/data/metadata/data_metadata.json'));
    if (metadata) {
