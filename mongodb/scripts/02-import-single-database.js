// Import all data from JSON files into single audit_data database
// This script imports data based on the data folder structure

print('🚀 Starting data import for single database...');
...
print(`📊 Total documents imported: ${totalImported}`);
